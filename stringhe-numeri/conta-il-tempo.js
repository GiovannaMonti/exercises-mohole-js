...
const hours = Math.floor(residualSeconds / secondsForHour)
...
const minutes = Math.floor(residualSeconds / secondsForMinute)
...
const seconds = Math.floor(residualSeconds)
